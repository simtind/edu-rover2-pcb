...
F 0 "D302" H 6450 3500 50  0000 C CNN
...
F 0 "D301" H 6300 3500 50  0000 C CNN
...
F 0 "C304" V 5600 2850 50  0000 C CNN
...
F 0 "C305" V 5700 3150 50  0000 C CNN
...
F 0 "C302" V 3850 2750 50  0000 C CNN
...
F 0 "C303" V 5300 2650 50  0000 C CNN
...
F 0 "R301" V 3880 4200 50  0000 C CNN
...
F 4 "Do not mount" H 3800 4200 50  0001 C CNN "Config"
F 5 "Jumper, use lefotver resistor legs" H 3800 4200 50  0001 C CNN "Description"
	1    3800 4200
	-1   0    0    1   
$EndComp
Wire Wire Line
...
F 0 "U301" H 3000 4700 50  0000 C CNN
...
F 0 "C301" V 3100 3950 50  0000 C CNN
...
Wire Notes Line
	1600 5275 3650 5275
$Comp
L Edurov:L6203 IC401
U 1 1 60738BFF
P 4800 3100
AR Path="/6003F027/60738BFF" Ref="IC401"  Part="1" 
...
F 0 "IC301" H 4800 3681 50  0000 C CNN
...
F 11 "STMicroelectronics" H 4800 3100 50  0001 C CNN "Manufacturer"
	...
	1    0    0    -1  
$EndComp
Text Notes 1700 5175 0    39   ~ 0
If the allegro part is hard to find, \nTMCS1101A4BQDR is a drop-in replacement.
Wire Notes Line
	3650 3400 3650 5275
Wire Notes Line
	1600 3400 1600 5275
